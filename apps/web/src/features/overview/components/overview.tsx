              ...
              <Card className="@container/card">
                ...
                <CardFooter className="flex-col items-start gap-1.5 text-sm">
                  <div className="line-clamp-1 flex gap-2 font-medium">
                    {t("overview.trendingUpMonth")}{" "}
                    <Icons.trendingUp className="size-4" />
                  </div>
                  <div className="text-muted-foreground">
                    {t("overview.visitors6Months")}
                  </div>
                </CardFooter>
              </Card>
              <Card className="@container/card">
                ...
                <CardFooter className="flex-col items-start gap-1.5 text-sm">
                  <div className="line-clamp-1 flex gap-2 font-medium">
                    {t("overview.downThisPeriod")}{" "}
                    <Icons.trendingDown className="size-4" />
                  </div>
                  <div className="text-muted-foreground">
                    {t("overview.acquisitionNeedsAttention")}
                  </div>
                </CardFooter>
              </Card>
              <Card className="@container/card">
                ...
                <CardFooter className="flex-col items-start gap-1.5 text-sm">
                  <div className="line-clamp-1 flex gap-2 font-medium">
                    {t("overview.strongRetention")}{" "}
                    <Icons.trendingUp className="size-4" />
                  </div>
                  <div className="text-muted-foreground">
                    {t("overview.engagementExceedsTargets")}
                  </div>
                </CardFooter>
              </Card>
              <Card className="@container/card">
                ...
                <CardFooter className="flex-col items-start gap-1.5 text-sm">
                  <div className="line-clamp-1 flex gap-2 font-medium">
                    {t("overview.steadyIncrease")}{" "}
                    <Icons.trendingUp className="size-4" />
                  </div>
                  <div className="text-muted-foreground">
                    {t("overview.meetsProjections")}
                  </div>
                </CardFooter>
              </Card>
            </div>
